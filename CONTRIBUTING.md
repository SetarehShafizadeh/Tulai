...
* [Submit a post for your issue](https://github.com/SetarehShafizadeh/Tulai/issues/), assuming one does not already exist.
...
* [Fork](https://github.com/SetarehShafizadeh/Tulai/#fork-destination-box) the repository on GitHub to make a copy of the repository on your account. 
...
* If you need help or unsure about anything, post an update to [your issue](https://github.com/SetarehShafizadeh/Tulai/issues/).

## Submitting your changes

Push to your fork and [submit a pull request](https://github.com/SetarehShafizadeh/Tulai/compare/).
...
* Engage in discussion on [your issue](https://github.com/SetarehShafizadeh/Tulai/issues/).
