...
# Create the data frame based on the example table
summary_table2_area <- data.frame(
  area = c("D1_a", "D1_c", "TA_d", "TA_e", "TP1_c"),
...
p <- ggplot(summary_table2_area, aes(x = lithic_volumetric_density, y = retouch_frequency)) +
