...
ggcorrplot(chisq$residuals,
           method = 'circle') + 
  scale_y_discrete(labels = function(y) str_to_upper(y)) +  # Convert x axis labels to uppercase
  scale_x_discrete(labels = function(x) str_to_lower(x)) +  # Convert x axis labels to uppercase
  ggplot2::scale_fill_gradient2(
    low = 'red',
    high = 'royalblue',
    mid = 'white',
