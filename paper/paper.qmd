...
```{r}
=======
>>>>>>> b5fa5208e22adcd0e5135d2fedcda051a5ebfc46
...
A permutation MANOVA indicates that there is a significant difference in the lithic assemblage composition across the three excavation areas (`rPerMANOVA_results_inline`). We investigated this further using pairwise post-hoc tests and found that this significant difference is between TA and TP1, with the other two areas being statisically indistinguishable (@tbl-permanova )
<<<<<<< HEAD
