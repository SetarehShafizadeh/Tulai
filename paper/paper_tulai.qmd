...
tl3 <- tl3 %>% 
  filter(!lithic_id %in% c("3154", "1741", "1680"))
```
...
kable(summary_table_layer, 
      caption = "Summary of lithics by Layer", 
      align = 'c') 

```

### Summary tables: AREA-LAYER:
...
kable(summary_table_al, 
      caption = "Summary of lithics by Area and layer") 
...
summary_table_depth_area_layer_to_join <- 
  summary_table_depth_area_layer

# Generate the table
kable(summary_table_depth_area_layer, 
      caption = "Summary of lithics by Depth, Area, and Layer")
```
...
# area, layer, level, depth. What is the equivalent above? tp1_c_3_a
